...
const serviceLinks = `<a href="vedic-astrology.html">Vedic Astrology</a><a href="medical-astrology.html">Medical Astrology</a><a href="numerology.html">Numerology</a><a href="vedic-vastu.html">Vedic Vastu</a><a href="astrological-counselling.html">Astrological Counselling</a><a href="birth-chart-analysis.html">Birth Chart Analysis</a><a href="kundali-matching.html">Kundali Matching</a><a href="love-astrology.html">Love Astrology</a><a href="financial-astrology.html">Financial Astrology</a><a href="career-astrology.html">Career Astrology</a><a href="business-astrology.html">Business Astrology</a>`;
...
<footer class="site-footer premium-footer">
  <div class="footer-cta">
    <div><p class="eyebrow light"><span></span> Your chart. Your questions. Your next chapter.</p><h2>Begin with a private conversation.</h2><p>Share what brings you here and the Riddhi Astrology team will help arrange the consultation best suited to your question.</p></div>
    <div class="footer-cta-actions"><a class="button footer-cta-primary" href="contact.html">Book a consultation <span>&nearr;</span></a><a class="footer-cta-call" href="tel:+919904025820">${phoneIcon}<span><small>Call Riddhi Astrology</small><strong>+91 99040 25820</strong></span></a></div>
  </div>
  <div class="footer-shell">
    <div class="footer-main">
      <div class="footer-brand"><img src="assets/images/logo.png" alt="Riddhi Astrology"><p>Personal astrology guidance for a life lived with clarity, confidence, and purpose.</p><p class="footer-brand-note">Private consultations in Vadodara, Bharuch, and online worldwide.</p><a class="icon-link social-link" href="https://www.instagram.com/riddhi_astrology?igsh=MWc0Mm01Nm9veGY5eQ==" target="_blank" rel="noopener">${instaIcon}<span>Follow on Instagram</span></a></div>
      <div class="footer-links"><h4>Explore</h4><a href="about.html">About Dr. Sunnita</a><a href="services.html">All consultations</a><a href="journal.html">Blogs & articles</a><a href="contact.html">Book a reading</a><a href="privacy-policy.html">Privacy policy</a><a href="terms-conditions.html">Terms & conditions</a></div>
      <div class="footer-service-list"><h4>Consultations</h4>${serviceLinks}</div>
      <div class="footer-contact"><h4>Visit & connect</h4><a class="icon-link footer-direct" href="tel:+919904025820">${phoneIcon}<span><small>Phone & WhatsApp</small>+91 99040 25820</span></a><a class="icon-link footer-direct" href="mailto:ridhhiastrology01@gmail.com">${mailIcon}<span><small>Email</small>ridhhiastrology01@gmail.com</span></a><p class="icon-link footer-address">${pinIcon}<span><strong>Vadodara</strong>404-405, Trivia Mall, Opp. Natubhai Circle, Gotri Road, Vadodara, Gujarat 390007</span></p><p class="icon-link footer-address">${pinIcon}<span><strong>Bharuch</strong>104-105, 1st Floor, Kunj Resi Plaza, Opp. Inox Multiplex, Zadeshwar Road, Bharuch - 390012, Gujarat</span></p></div>
    </div>
